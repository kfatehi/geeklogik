...
# How good is your current job? (1-10 with 10 being "ambassador to Italy")
G = 7

# How many kids do you have?
K = 0

# Your chances of quickly finding another job (1-10 with 10 being "already signed a new contract")
P = 9

# Your level of financial commitment (1-10 with 10 being "mortgaged into the next milennium")
F = 2
